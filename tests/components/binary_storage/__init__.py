...
def override_manifest(manifest: ComponentManifestOverride) -> None:
    # inplace_kv.cpp is gated by USE_BINARY_STORAGE_INPLACE_KV, normally emitted by a `mode: kv`
    # device. The C++ unit test drives InplaceKVStore over a mock RawStorage, so emit the define
