...
async def to_code(config):
    ...
    esp32.add_idf_component(
        name="ESP32-A2DP",
        repo="https://github.com/pschatzmann/ESP32-A2DP.git",
        ref="main",
    )
    # The library builds its I2S output stage against arduino-audio-tools as soon
    # as AudioTools.h is reachable, and A2DP_LEGACY_I2S_SUPPORT is the pre-5.0
    # driver. The source role needs neither: Frame is defined in
    # A2DPVolumeControl.h and the audio arrives through the callback.
