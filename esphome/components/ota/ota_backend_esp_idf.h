...
class IDFOTABackend final {
 ...
 protected:
  ...
  // through it too (its original guarded placement broke exactly those builds, since both
  // the call site and the definition in ota_backend_esp_idf.cpp are unguarded).
