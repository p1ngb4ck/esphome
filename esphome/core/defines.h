...
#define USE_ESP32_HOSTED_STORAGE_UPDATE
...
#define USE_STORAGE_COPY_CHUNK_SIZE 16384
#define USE_STORAGE_DEVICE_NODES
#define USE_STORAGE_JSON_EXTRACT
#define USE_STORAGE_MAX_DEVICES 8
...
#define USE_BINARY_STORAGE
#define USE_BINARY_STORAGE_I2C
#define USE_BINARY_STORAGE_I2C_FRAM
#define USE_BINARY_STORAGE_I2C_EEPROM
#define USE_BINARY_STORAGE_SPI
#define USE_BINARY_STORAGE_SPI_FLASH
#define USE_BINARY_STORAGE_SPI_FRAM
#define USE_BINARY_STORAGE_SPI_MRAM
#define USE_BINARY_STORAGE_ONEWIRE
#define USE_BINARY_STORAGE_ONEWIRE_EEPROM
#define USE_BINARY_STORAGE_LITTLEFS
#define USE_BINARY_STORAGE_PREFILL
#define USE_BINARY_STORAGE_NVS
#define USE_BINARY_STORAGE_INPLACE_KV
#define USE_SD_STORAGE
#define USE_USB_STORAGE
#define USE_WEBDAV_SERVER
#define USE_HTTP_FILE_BROWSER
#define USE_SWITCH
#define USE_TEXT
...
#define USE_OTA_PARTITIONS
#define USE_ESP32_MIN_CHIP_REVISION_SET
#define USE_ESP32_PREFERENCES_STORAGE
